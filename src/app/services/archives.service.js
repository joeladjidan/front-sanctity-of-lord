...
exports.ArchivresService = void 0;
var core_1 = require("@angular/core");
var base_service_1 = require("../../components/base-service");
var http_1 = require("@angular/common/http");
var operators_1 = require("rxjs/operators");
var rxjs_1 = require("rxjs");
var ArchivresService = /** @class */ (function (_super) {
    __extends(ArchivresService, _super);
    function ArchivresService(config, http) {
        var _this = _super.call(this, config, http) || this;
        _this.baseUrl = _this.rootUrl + "/archivre";
        return _this;
    }
    ArchivresService.prototype.getListArchivre = function () {
    ...
    ArchivresService.prototype.searchArchivre = function (mois, annee) {
        var __params = this.newParams();
        var __headers = new http_1.HttpHeaders();
        __headers.set('Access-Control-Allow-Origin', '*');
        var __body = null;
        var req = new http_1.HttpRequest('GET', "".concat(this.baseUrl, "/search/").concat(mois, "/").concat(annee), __body, {
            headers: __headers,
            params: __params,
            responseType: 'json'
        });
    ...
    // Handle API errors
    ArchivresService.prototype.handleError = function (error) {
        debugger;
    ...
    ;
    ArchivresService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        })
    ], ArchivresService);
    return ArchivresService;
}(base_service_1.BaseService));
exports.ArchivresService = ArchivresService;
