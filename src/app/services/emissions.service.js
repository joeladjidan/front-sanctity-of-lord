...
var EmissionsService = /** @class */ (function (_super) {
    __extends(EmissionsService, _super);
    function EmissionsService(config, http) {
        var _this = _super.call(this, config, http) || this;
        _this.baseUrl = _this.rootUrl + "/emission";
        // Http Options
        _this.httpOptions = {
    ...
    // Handle API errors
    EmissionsService.prototype.handleError = function (error) {
