...
export class TypeEnseignementService extends __BaseService {

  private baseUrl = this.rootUrl + `/type-enseignement`;
  ...
  getTypeEnseignement(): Observable<__StrictHttpResponse<Array<TypeEnseignementDto>>> {
    ...
    return this.http.request<any>(req)
      .pipe(
        ...
        __map((__r) => {
          return __r as __StrictHttpResponse<Array<TypeEnseignementDto>>;
        }),
      );
  }
