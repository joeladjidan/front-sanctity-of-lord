...
exports.AnneeService = void 0;
var core_1 = require("@angular/core");
var base_service_1 = require("../../components/base-service");
var http_1 = require("@angular/common/http");
var operators_1 = require("rxjs/operators");
var AnneeService = /** @class */ (function (_super) {
    __extends(AnneeService, _super);
    function AnneeService(config, http) {
        var _this = _super.call(this, config, http) || this;
        _this.baseUrl = _this.rootUrl + "/annee";
        return _this;
    }
    AnneeService.prototype.getListAnnee = function () {
...
exports.AnneeService = AnneeService;
