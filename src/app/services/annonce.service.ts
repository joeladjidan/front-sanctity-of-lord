...
export class AnnonceService extends __BaseService {

  private baseUrl = this.rootUrl + `/annonce`;
  ...
  getListAnnonce(): Observable<__StrictHttpResponse<Array<AnnonceDto>>> {
    ...
    return this.http.request<any>(req).pipe(
      ...
      __map((__r) => {
        return __r as __StrictHttpResponse<Array<AnnonceDto>>;
      }),
    );
  }
