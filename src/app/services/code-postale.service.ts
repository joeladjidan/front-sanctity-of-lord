...
export class CodePostaleService extends __BaseService {

  private baseUrl = this.rootUrl + `/code-postale`;
  ...
  getListCodePostale(): Observable<__StrictHttpResponse<Array<CodePostaleDto>>> {
    ...
    return this.http.request<any>(req).pipe(
      ...
      __map((__r) => {
        return __r as __StrictHttpResponse<Array<CodePostaleDto>>;
      }),
    );
  }
