...
var PaysService = /** @class */ (function (_super) {
    __extends(PaysService, _super);
    function PaysService(config, http) {
        var _this = _super.call(this, config, http) || this;
        _this.baseUrl = _this.rootUrl + "/pays";
        return _this;
    }
    PaysService.prototype.getListPays = function () {
    ...
    // Handle API errors
    PaysService.prototype.handleError = function (error) {
