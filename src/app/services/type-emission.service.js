...
exports.TypeEmissionService = void 0;
var core_1 = require("@angular/core");
var http_1 = require("@angular/common/http");
var rxjs_1 = require("rxjs");
var operators_1 = require("rxjs/operators");
var base_service_1 = require("@docs-components/base-service");
var TypeEmissionService = /** @class */ (function (_super) {
    __extends(TypeEmissionService, _super);
    function TypeEmissionService(config, http) {
        var _this = _super.call(this, config, http) || this;
        _this.baseUrl = _this.rootUrl + "/type-emission";
        return _this;
    }
    TypeEmissionService.prototype.getTypeEmission = function () {
    ...
    // Handle API errors
    TypeEmissionService.prototype.handleError = function (error) {
    ...
    ;
    TypeEmissionService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        })
    ], TypeEmissionService);
    return TypeEmissionService;
}(base_service_1.BaseService));
exports.TypeEmissionService = TypeEmissionService;
