...
var AnnonceService = /** @class */ (function (_super) {
    __extends(AnnonceService, _super);
    function AnnonceService(config, http) {
        var _this = _super.call(this, config, http) || this;
        _this.baseUrl = _this.rootUrl + "/annonce";
        return _this;
    }
    AnnonceService.prototype.getListAnnonce = function () {
    ...
    // Handle API errors
    AnnonceService.prototype.handleError = function (error) {
        debugger;
