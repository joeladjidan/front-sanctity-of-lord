...
var GalerieService = /** @class */ (function (_super) {
    __extends(GalerieService, _super);
    function GalerieService(config, http) {
        var _this = _super.call(this, config, http) || this;
        _this.baseUrl = _this.rootUrl + "/galerie";
        // Http Options
        _this.httpOptions = {
    ...
    GalerieService.prototype.enregistrer = function (data) {
        return this.http
            .post(this.baseUrl + "/enregistrer", data, this.httpOptions)
            .pipe((0, operators_1.retry)(2), (0, operators_1.catchError)(this.handleError));
    };
    GalerieService.prototype.ajouterImage = function (file) {
        var url = this.baseUrl + "/image";
        var formdata = new FormData();
        formdata.append('fichier', file);
        return this.http.post(url, formdata).pipe((0, operators_1.catchError)(this.handleError));
    };
    GalerieService.prototype.getData = function () {
    ...
    // Handle API errors
    GalerieService.prototype.handleError = function (error) {
