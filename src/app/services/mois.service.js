...
exports.MoisService = void 0;
var core_1 = require("@angular/core");
var base_service_1 = require("../../components/base-service");
var http_1 = require("@angular/common/http");
var operators_1 = require("rxjs/operators");
var MoisService = /** @class */ (function (_super) {
    __extends(MoisService, _super);
    function MoisService(config, http) {
        var _this = _super.call(this, config, http) || this;
        _this.baseUrl = _this.rootUrl + "/mois";
        return _this;
    }
    MoisService.prototype.getListMois = function () {
