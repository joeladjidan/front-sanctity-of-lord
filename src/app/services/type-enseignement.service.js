...
exports.TypeEnseignementService = void 0;
var core_1 = require("@angular/core");
var http_1 = require("@angular/common/http");
var rxjs_1 = require("rxjs");
var operators_1 = require("rxjs/operators");
var base_service_1 = require("@docs-components/base-service");
var TypeEnseignementService = /** @class */ (function (_super) {
    __extends(TypeEnseignementService, _super);
    function TypeEnseignementService(config, http) {
        var _this = _super.call(this, config, http) || this;
        _this.baseUrl = _this.rootUrl + "/type-enseignement";
        return _this;
    }
    TypeEnseignementService.prototype.getTypeEnseignement = function () {
    ...
    // Handle API errors
    TypeEnseignementService.prototype.handleError = function (error) {
    ...
    ;
    TypeEnseignementService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        })
    ], TypeEnseignementService);
    return TypeEnseignementService;
}(base_service_1.BaseService));
exports.TypeEnseignementService = TypeEnseignementService;
