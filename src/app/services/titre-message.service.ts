...
export class TitreMessageService extends __BaseService {

  private baseUrl = this.rootUrl + `/titre-message`;
  ...
  getTitreMessage(): Observable<__StrictHttpResponse<Array<TitreMessageDto>>> {
    ...
    return this.http.request<any>(req)
      .pipe(
        ...
        __map((__r) => {
          return __r as __StrictHttpResponse<Array<TitreMessageDto>>;
        }),
      );
  }
