...
export class CiviliteService extends __BaseService {

  private baseUrl = this.rootUrl + `/civilite`;
  ...
  getListCivilite(): Observable<__StrictHttpResponse<Array<CiviliteDto>>> {
    ...
    return this.http.request<any>(req).pipe(
      ...
      __map((__r) => {
        return __r as __StrictHttpResponse<Array<CiviliteDto>>;
      }),
    );
  }
