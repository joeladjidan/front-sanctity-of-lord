...
exports.TitreMessageService = void 0;
var core_1 = require("@angular/core");
var http_1 = require("@angular/common/http");
var rxjs_1 = require("rxjs");
var operators_1 = require("rxjs/operators");
var base_service_1 = require("@docs-components/base-service");
var TitreMessageService = /** @class */ (function (_super) {
    __extends(TitreMessageService, _super);
    function TitreMessageService(config, http) {
        var _this = _super.call(this, config, http) || this;
        _this.baseUrl = _this.rootUrl + "/titre-message";
        return _this;
    }
    // Handle API errors
    TitreMessageService.prototype.handleError = function (error) {
    ...
    ;
    TitreMessageService.prototype.getTitreMessage = function () {
    ...
    TitreMessageService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        })
    ], TitreMessageService);
    return TitreMessageService;
}(base_service_1.BaseService));
exports.TitreMessageService = TitreMessageService;
