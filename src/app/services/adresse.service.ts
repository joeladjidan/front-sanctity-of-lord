...
export class AdresseService extends __BaseService {

  private baseUrl = this.rootUrl + `/adresse`;
  ...
  getListAdresse(): Observable<__StrictHttpResponse<Array<AdresseDto>>> {
    ...
    return this.http.request<any>(req).pipe(
      ...
      __map((__r) => {
        return __r as __StrictHttpResponse<Array<AdresseDto>>;
      }),
    );
  }
